...
def main():
    ...
    if args.dataset == "mil":
        ...
        unzip_data('mil-dataset.zip', 'datasets/precomputed')
    ...
    if args.dataset == "tcga":
        ...
        unzip_data('tcga-dataset.zip', 'datasets/precomputed/tcga')
    ...
    if args.dataset == "c16":
        ...
        unzip_data('c16-dataset.zip', 'datasets/precomputed/c16')
    ...
    if args.dataset == "tcga-test":
        ...
        try:
            unzip_data('tcga-dataset-test.zip', 'datasets/TCGA')
    ...
    if args.dataset == "c16-test":
        ...
        try:
            unzip_data('c16-dataset-test.zip', 'datasets/c16')
